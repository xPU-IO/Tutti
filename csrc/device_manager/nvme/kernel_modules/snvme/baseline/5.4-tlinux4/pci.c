 ...
 * takes the controller maximum: NVMe CAP.MQES + 1.  User IOQs created
 * via NVM_ADD_USER_QUEUE support multi-page ring memory, so the old
 * single-page clamp (depth <= 64) no longer applies.
 */
